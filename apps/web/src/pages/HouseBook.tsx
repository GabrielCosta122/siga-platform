...
import { getPublishedChapters } from '@/store/selectors'
...
function HouseBook() {
  ...
  const filteredChapters = useMemo(() => [...chapters].sort((a, b) => b.date.localeCompare(a.date)).filter(chapter => {
