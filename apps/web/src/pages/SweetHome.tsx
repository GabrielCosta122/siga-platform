...
function SweetHome() {
  ...
  const chronologicalChapters = getRecentChapters(state, state.chapters.length)
  const recent = chronologicalChapters.slice(0, 3)
  const coverChapters = chronologicalChapters.slice(0, 4)
